...
# }
     ...
     3.43s  agent 발화 시작: <ret> That’s a good question, staying active is important. V
     3.46s  user  발화 끝
     5.11s  ⚡SPAN 주입 [d'=2.00s / d_lead=3.24s]: [source: Wikipedia] Vince Carter is the oldest player in the NBA, at a
    12.33s  agent 발화 끝
