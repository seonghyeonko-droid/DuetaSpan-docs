...
# }
     ...
     3.45s  agent 발화 시작: <ret> That’s a popular question, and I can certainly tell yo
     3.56s  user  발화 끝
     4.73s  ⚡SPAN 주입 [d'=1.52s / d_lead=3.78s]: Daredevil season three was released on October 26, 2018.
    11.00s  agent 발화 끝
