...
# }
     ...
     3.24s  user  발화 끝
     3.30s  agent 발화 시작: <ret> That’s a popular question, and I can certainly tell yo
     4.58s  ⚡SPAN 주입 [d'=1.52s / d_lead=3.71s]: Daredevil season three was released on October 26, 2018.
    10.71s  agent 발화 끝
