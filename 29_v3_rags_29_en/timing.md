...
# }
     ...
     3.37s  user  발화 끝
     3.39s  agent 발화 시작: <ret> That's a good question, and a testament to dedication.
     5.07s  ⚡SPAN 주입 [d'=2.00s / d_lead=3.27s]: Vince Carter is the oldest player in the NBA, at age forty-one as of O
    11.73s  agent 발화 끝
