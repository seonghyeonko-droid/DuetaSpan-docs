...
# EXAMINER(FDB-v2) 단계: S1 Hi, I'm feeling really stressed la | S2 Okay, that makes sense. Can you te | S3 That sounds easy enough. What abou | S4 Oh, I definitely use my phone in b
    ...
    34.96s  user  발화 끝
    35.29s  <ret> 발화 (turn12 첫 프레임)
    35.67s  ⚡SPAN 주입 [d'=0.71s / d_lead=4.99s]: Abu Ali al-Husayn ibn Abd Allah ibn Sina, commonly known in the West a
    ...
    40.72s  agent 발화 끝
    43.56s  <ret> 발화 (turn14 첫 프레임)
    43.79s  agent 발화 시작: <ret> I'm sorry, I don’t have any information about Ibn Sina
    43.79s  user  발화 끝
    44.80s  ⚡SPAN 주입 [d'=1.24s / d_lead=5.38s]: (no information found)
