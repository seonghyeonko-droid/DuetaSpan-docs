...
# EXAMINER(FDB-v2) 단계: S1 Hey Tuna, I'm trying to remember w | S2 That’s it! But wait – didn't he do | S3 …do you know what else he’s been i | S4 Wow, that’s a lot! He’s really ver
    ...
    14.65s  ⚡SPAN 주입 [d'=0.85s / d_lead=8.81s]: J. P. Manoux voiced Kuzco in *The Emperor's New School*, reprising the
    ...
    34.26s  agent 발화 끝
    37.59s  <ret> 발화 (turn8 첫 프레임)
    37.85s  agent 발화 시작: <ret> J. P. Manoux is actually quite prolific, with roles in
    37.85s  user  발화 끝
    38.28s  ⚡SPAN 주입 [d'=0.69s / d_lead=6.53s]: (tool result) J. P. Manoux is an American voice actor known for his wo
