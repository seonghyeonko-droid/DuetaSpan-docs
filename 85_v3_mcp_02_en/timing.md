...
# EXAMINER(FDB-v2) 단계: S1 I need to get bus tickets from Hou | S2 …Are there any buses with Wi-Fi on | S3 Okay, change my booking to the 8:0 | S4 That sounds nice. Thanks for your 
     ...
     4.26s  user  발화 끝
     6.28s  <ret> 발화 (turn2 첫 프레임)
     6.56s  agent 발화 시작: <ret> [happy] Certainly, I've secured three bus tickets from
     6.56s  user  발화 끝
     6.58s  ⚡SPAN 주입 [d'=0.30s / d_lead=6.23s]: (tool result) Confirmation: HOU-DAL, 06:15, June 1, 3 tickets, ID: 872
    ...
    15.74s  user  발화 끝
    16.87s  ⚡SPAN 주입 [d'=1.50s / d_lead=5.57s]: (tool result) 06:15, 08:00, 10:30 departures offer Wi-Fi.
    21.31s  user  발화 시작: Yeah.
    21.31s  agent 발화 끝
    21.64s  user  발화 시작: Okay, change my booking to the 8:00 AM bus with Wi-Fi.
    21.64s  user  발화 끝
    24.99s  <ret> 발화 (turn8 첫 프레임)
    25.25s  agent 발화 시작: Yeah.
    25.25s  user  발화 끝
    25.32s  ⚡SPAN 주입 [d'=0.33s / d_lead=6.56s]: (tool result) Confirmation: HOU-DAL, 08:00, June 1, 3 tickets, Wi-Fi, 
    ...
    36.73s  user  발화 끝
    36.88s  <ret> 발화 (turn11 첫 프레임)
    37.05s  agent 발화 시작: <ret> It looks like Dallas on June first will be 27.8 degree
    37.05s  agent 발화 끝
    37.96s  ⚡SPAN 주입 [d'=1.08s / d_lead=9.18s]: (tool result) 27.8°C, humidity 65%, wind 8.2 km/h, partly cloudy.
