...
# }
     ...
     9.94s  user  발화 끝
    10.45s  ⚡SPAN 주입 [d'=0.99s / d_lead=4.17s]: [2026-01-29] User is planning a trip to New Zealand in March.
    ...
    37.85s  user  발화 끝
    38.10s  ⚡SPAN 주입 [d'=0.39s / d_lead=7.38s]: Flights from San Francisco to Auckland, New Zealand, starting at $1200
