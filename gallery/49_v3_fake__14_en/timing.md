...
# EXAMINER(FDB-v2) 단계: S1 I’m planning a wine tasting trip,  | S2 Wow, thirteen varieties! That’s a  | S3 Eighteen? That’s even more. | S4 That sounds great, actually. I’d l
    ...
    15.95s  user  발화 끝
    16.62s  ⚡SPAN 주입 [d'=1.19s / d_lead=9.22s]: Châteauneuf-du-Pape is the most famous appellation in the southern Rhô
    ...
    35.45s  user  발화 끝
    35.69s  <ret> 발화 (turn10 첫 프레임)
    35.81s  agent 발화 시작: <ret> Actually, other areas do too—the Côtes du Rhône wines 
    35.81s  agent 발화 끝
    36.28s  ⚡SPAN 주입 [d'=0.59s / d_lead=8.15s]: The regulations for Côtes du Rhône wines permit the use of up to eight
    ...
    48.21s  agent 발화 끝
    51.74s  <ret> 발화 (turn14 첫 프레임)
    51.76s  agent 발화 시작: <ret> Not always, but many producers are starting to include
    51.76s  user  발화 끝
    53.10s  ⚡SPAN 주입(IRRELEVANT) [d'=1.36s / d_lead=8.15s]: The average high temperature in Fairbanks, Alaska in January is -17.8°
